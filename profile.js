...
async function loadProfileDataFromAPI() {
    const url = `https://yrvi6y00u8.execute-api.us-west-2.amazonaws.com/dev/company/get/${cid}`;
...
const customerAPIUrlBase = `https://yrvi6y00u8.execute-api.us-west-2.amazonaws.com/dev/customer`;
const companyAPIUrlBase = `https://yrvi6y00u8.execute-api.us-west-2.amazonaws.com/dev/company`;
