...
async function createCheckoutSession() {
    try {
        ...
        const link3 = "https://arjavatech.github.io/tap-time-dev"
        const response = await fetch(`https://yrvi6y00u8.execute-api.us-west-2.amazonaws.com/dev/create-checkout-session`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
